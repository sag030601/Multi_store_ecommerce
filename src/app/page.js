...
import { ShoppingCart, Search, Menu, X, Heart, Star, TrendingUp } from "lucide-react";
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="/" className="text-gray-700 hover:text-yellow-500 font-medium transition">
                Home
              </a>
              <a href="/shop" className="text-gray-700 hover:text-yellow-500 font-medium transition">
                Shop
              </a>
              <a href="/deals" className="text-gray-700 hover:text-yellow-500 font-medium transition">
                Deals
              </a>
              <a href="/contact" className="text-gray-700 hover:text-yellow-500 font-medium transition">
                Contact
              </a>
            </nav>
          ...
          {isMenuOpen && (
            <nav className="md:hidden py-4 border-t">
              <a href="/" className="block py-2 text-gray-700 hover:text-yellow-500 font-medium">
                Home
              </a>
              <a href="/shop" className="block py-2 text-gray-700 hover:text-yellow-500 font-medium">
                Shop
              </a>
              <a href="/deals" className="block py-2 text-gray-700 hover:text-yellow-500 font-medium">
                Deals
              </a>
              <a href="/contact" className="block py-2 text-gray-700 hover:text-yellow-500 font-medium">
                Contact
              </a>
            </nav>
          )}
      ...
      <section className="container mx-auto px-4 -mt-16 relative z-20">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            ...
            {['Electronics', 'Fashion', 'Home Decor', 'Sports', 'Books'].map((tag) => (
              <button
                key={tag}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/shop" className="text-gray-400 hover:text-yellow-400 transition">Shop</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/faq" className="text-gray-400 hover:text-yellow-400 transition">FAQ</a></li>
                <li><a href="/shipping" className="text-gray-400 hover:text-yellow-400 transition">Shipping</a></li>
                <li><a href="/returns" className="text-gray-400 hover:text-yellow-400 transition">Returns</a></li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold text-lg mb-4">Newsletter</h5>
              <p className="text-gray-400 text-sm mb-3">Subscribe for exclusive deals</p>
              <div className="flex">
                <input
                  type="email"
