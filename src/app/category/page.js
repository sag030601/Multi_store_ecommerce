...
export default function AddCategoryPage() {
  const { storeId, setCategoryId } = useStore(); // ✅ include setCategoryId
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setCategoryId(data.id); // ✅ store the created category id
...
const styles = {
  ...
  button: { padding: "10px 20px", backgroundColor: "#2196F3", color: "white", border: "none", borderRadius: "5px" },
